    ...
    data.forEach(obj => {
        ...
        celdasCabecera.forEach(c => {
            ...
            if (contenidoCabecera === "Id") {
                fila.setAttribute("id", obj[contenidoCabecera.toLowerCase()]);
                
            }
            celda.id = contenidoCabecera;
            celda.textContent = obj[contenidoCabecera.toLowerCase()];
...
function RefrescarTabla(tabla,cabecera,cuerpo,data){
    VaciarTabla(cuerpo);
