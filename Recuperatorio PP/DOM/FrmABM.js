...
export function InicializarFrmABM(){
    ...
    const propiedadesPersonasDivision = Array.from(ObtenerElementoPorId("camposPersona").children);
    const contenedorAtributosEspeciales = Array.from(ObtenerElementoPorId("camposSegunTipo").children);
    const campos = propiedadesPersonasDivision.concat(contenedorAtributosEspeciales);
    ...
    AsignarClase(propiedadesPersonasDivision,"field-person");
    AsignarClase(contenedorAtributosEspeciales,"field-typeOfPerson");
