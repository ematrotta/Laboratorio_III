...
function ObtenerObjetos(){
    ...
    xhttp.open("GET", "http://localhost/API_LaboIII/personasFutbolitasProfesionales.php", true); //Inicializo la solicitud
    xhttp.send(); //Envio la solicitud
}

async function AgregarObjeto(object){
    return await fetch('http://localhost/API_LaboIII/personasFutbolitasProfesionales.php', {
...
function ModificarObjeto(objeto){
    ...
    return new Promise((exito,error)=>{
            fetch('http://localhost/API_LaboIII/personasFutbolitasProfesionales.php', {
